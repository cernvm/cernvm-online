...
(function($) {
    ...
    CVMO.Market.addEnv = function( name, value, required ) {
		...
		$('#table_env_body').append(jQuery('<tr id="env-entry-'+name+'" class="cvm-environment-entry">\
			...
			<td class="v-middle" align="center"><a href="javascript:;" onclick="CVMO.Market.removeEnv(\'env-entry-'+name+'\');" class="softbutton"><img border="0" src="/static/market/img/page_delete.png" align="absmiddle"> Remove variable</a></td>\
		</tr>'));
    };
