...
if settings.ENABLE_MARKET:
    urlpatterns += patterns('cvmo.context.views.marketplace',
        ...
        url(r'^' + URL_PREFIX + 'marketplace$', 'marketplace', name='marketplace'),
        url(r'^' + URL_PREFIX + 'marketplace_detail/(?P<id>.*)/$', 'marketplace_detail', name='marketplace_list'),
        url(r'^' + URL_PREFIX + 'import_to_dashboard/(?P<id>[-\w]+)$', 'import_to_dashboard', name="import_to_dashboard"),
    )
...
urlpatterns += patterns('',
    ...
    url(r'^' + URL_PREFIX + 'comments/', include('django.contrib.comments.urls')),
    url(r'^' + URL_PREFIX + 'search/', include('haystack.urls')),
)
