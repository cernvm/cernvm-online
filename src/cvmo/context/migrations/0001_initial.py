...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ContextDefinition'
        db.create_table(u'context_contextdefinition', (
            ...
            ('from_abstract', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('data', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal(u'context', ['ContextDefinition'])

        # Adding model 'ContextStorage'
        db.create_table(u'context_contextstorage', (
            ('id', self.gf('django.db.models.fields.CharField')(max_length=64, primary_key=True)),
            ('data', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal(u'context', ['ContextStorage'])


    def backwards(self, orm):
        # Deleting model 'ContextDefinition'
        db.delete_table(u'context_contextdefinition')

        # Deleting model 'ContextStorage'
        db.delete_table(u'context_contextstorage')
