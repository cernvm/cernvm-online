...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ClusterDefinition.ec2_json'
        db.add_column(u'cluster_clusterdefinition', 'ec2_json',
                      self.gf('django.db.models.fields.TextField')(default='{}'),
                      keep_default=False)

        # Adding field 'ClusterDefinition.quota_json'
        db.add_column(u'cluster_clusterdefinition', 'quota_json',
                      self.gf('django.db.models.fields.TextField')(default='{}'),
                      keep_default=False)

        # Adding field 'ClusterDefinition.elastiq_json'
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'ClusterDefinition.quota'
        raise RuntimeError("Cannot reverse this migration. 'ClusterDefinition.quota' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'ClusterDefinition.quota'
        db.add_column(u'cluster_clusterdefinition', 'quota',
                      self.gf('django.db.models.fields.TextField')(),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'ClusterDefinition.ec2'
        raise RuntimeError("Cannot reverse this migration. 'ClusterDefinition.ec2' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'ClusterDefinition.ec2'
        db.add_column(u'cluster_clusterdefinition', 'ec2',
                      self.gf('django.db.models.fields.TextField')(),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'ClusterDefinition.elastiq'
        raise RuntimeError("Cannot reverse this migration. 'ClusterDefinition.elastiq' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'ClusterDefinition.elastiq'
    ...
    models = {
        ...
        u'cluster.clusterdefinition': {
            ...
            'additional_params_json': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'deployable_context': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['context.ContextStorage']"}),
            'description': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'ec2_json': ('django.db.models.fields.TextField', [], {}),
            'elastiq_json': ('django.db.models.fields.TextField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'quota_json': ('django.db.models.fields.TextField', [], {}),
