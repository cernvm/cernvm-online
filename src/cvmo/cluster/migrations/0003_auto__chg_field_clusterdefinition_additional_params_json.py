...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ClusterDefinition.additional_params_json'
        db.alter_column(u'cluster_clusterdefinition', 'additional_params_json', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):

        # Changing field 'ClusterDefinition.additional_params_json'
        db.alter_column(u'cluster_clusterdefinition', 'additional_params_json', self.gf('django.db.models.fields.TextField')(null=True))
    ...
    models = {
        ...
        u'cluster.clusterdefinition': {
            ...
            'additional_params_json': ('django.db.models.fields.TextField', [], {'default': "'{}'"}),
