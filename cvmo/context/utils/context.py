...
def gen_pin(length, encrypted, salt):
    ...
    This pairing key contains also additional information
    that reduce the number of required requests. Usually
    pin is 6-digit long random number with some special rules
    on it's digits:
    ...
    E: The last digit defines if the context is encrypted
       or not.
    ...
    if encrypted:
        ...
        # First make sure n1+n2 is not zero
        while (n4 > 9):
            n1 = randint(0,r)
            n2 = randint(0,r)
            n3 = randint(0,r)
